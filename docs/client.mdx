...
```bash
go get github.com/agentuity/mcp-golang
```
...
For a complete working example, check out our [example client implementation](https://github.com/agentuity/mcp-golang/tree/main/examples/client).
